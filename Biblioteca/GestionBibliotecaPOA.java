 ...
 implements Biblioteca.GestionBibliotecaOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("buscarLibros", new java.lang.Integer (0));
    _methods.put ("buscarLibro", new java.lang.Integer (1));
  ...
  // Lista completa de libros
       case 0:  // Biblioteca/GestionBiblioteca/buscarLibros
       {
         Biblioteca.ListaLibrosHolder libros = new Biblioteca.ListaLibrosHolder ();
         this.buscarLibros (libros);
         out = $rh.createReply();
         Biblioteca.ListaLibrosHelper.write (out, libros.value);
         break;
       }


  // Busca un libro por título y devuelve los detalles del libro
       case 1:  // Biblioteca/GestionBiblioteca/buscarLibro
       {
